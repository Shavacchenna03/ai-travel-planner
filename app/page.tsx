...
export const metadata = {
  title: "Roamly — Considered Personal Travel Planner",
...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#faf8f5] text-[#0f172a] font-sans overflow-x-hidden flex flex-col">
      {/* Top Header */}
      <NavigationHeader />
            ...
            <div className="grid gap-8 sm:gap-10 lg:grid-cols-12 lg:items-center">
              ...
              <div className="lg:col-span-7 flex flex-col items-start space-y-5 sm:space-y-6">
                ...
                <div className="inline-flex items-center gap-2 rounded-full border border-[#f97316]/20 bg-[#ffedd5]/80 px-3.5 py-1.5 text-xs font-bold uppercase tracking-wider text-[#ea580c] shadow-xs">
                  ...
                  <span>Considered Personal Travel Planner</span>
                </div>
                ...
                <div className="grid gap-2.5 pt-1 text-xs sm:text-sm font-semibold text-slate-700 sm:grid-cols-2">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span>Bespoke Travel Plans</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <span className="flex size-5 shrink-0 items-center justify-center rounded-full bg-[#f97316] text-white">
                      <Check className="size-3" />
              ...
              <div className="lg:col-span-5 relative">
                <div className="relative mx-auto max-w-md lg:max-w-none">
                  ...
                  <div className="absolute -bottom-4 -left-4 z-20 hidden sm:flex items-center gap-3 rounded-2xl border border-[#eae4d9] bg-white p-3.5 shadow-xl">
                    ...
                    <div>
                      <p className="text-xs font-extrabold text-[#0f172a]">Daily Itineraries</p>
          ...
          <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-12">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="card-warm p-6 sm:p-8 text-center flex flex-col items-center bg-white">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#0f172a]">Tailored Day-by-Day Plans</h3>
                <p className="mt-2 text-xs sm:text-sm text-slate-600 leading-relaxed">
                  Roamly balances timings, weather forecasts, places to visit, meal spots, and travel tips tailored to your pace.
                </p>
              </div>
